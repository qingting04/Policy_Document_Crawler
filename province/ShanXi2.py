...
def get_url(policy):
    url = f'https://www.shanxi.gov.cn/zcwjkweb/#/Szffile?keywords={policy}'
    ...
    try:
        ...
        zcwj = driver.find_element(By.XPATH, "//*[@class='filter_content']/div[9]/div[2]//label[1]")
        zcwj.click()
        wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, '.el-loading-mask[style="display: none;"]')))
        ...
        while True:
            ...
            count += 1
            poli = driver.find_elements(By.XPATH, "//*[@class='left']/ul/li")

            for elements in poli:
                line = elements.find_elements(By.CLASS_NAME, "content.fl")
                record = {
                    ...
                    'createDate': elements.find_element(By.CLASS_NAME, 'date.fl').text,  # 发文时间
                    'content': ''  # 文章内容
                }
...
def get_content(data_process):
    ...
    xpath = "//*[contains(@class, 'TRS_UEDITOR trs_paper_default')]"
    try:
        count = 0
